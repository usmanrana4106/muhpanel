            ...
            <div class="content">
                ...
                <div class="col-md-12">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <form  action="{{ route('Admin.createCompanies') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <span class="bmd-help">Enter here Confirm password</span>
                                        </div>
                                    </div>
                                </div>
