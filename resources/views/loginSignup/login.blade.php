...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ url('public/assets/img/muhrahlogo.png') }}">
  ...
  <!-- CSS Files -->
  <link href="{{ url('public/assets/css/material-dashboard.css?v=2.0.2') }}" rel="stylesheet" />
      ...
      <footer class="footer">
        <div class="container">
          ...
          <div class="copyright float-right">
            ...
            <a href="#" target="_blank">Muhrah</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
...
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA-tZCZxS_XL91fdqC3eC14vc6AFGk02n8"></script>
<!-- Chartist JS -->
...
<script src="{{ url('public/assets/js/material-dashboard.min.js?v=2.0.2') }}" type="text/javascript"></script>
